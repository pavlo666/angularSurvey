...
/* global describe: true, beforeEach: true, inject: true, it: true, module: true, expect: true, browser: true, by: true, element: true*/
...
(function () {
    ...
    describe('survey homepage', function() {
        ...
        it('used menu item should redirect to index.html#/used', function(){
            ...
            element(by.id('used')).click();

            browser.getLocationAbsUrl().then(function (url) {
                expect(url).toEqual('/used');
            });
